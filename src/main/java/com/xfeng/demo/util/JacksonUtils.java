...
public class JacksonUtils {
    ...
    public static <T> T readJson2Entity(String jsonString, Class<T> clazz) {
        if (jsonString != null) {
            try {
                ...
                logger.error("readJson2Entity error jsonString={},class={}", jsonString, clazz.getName(), var3);
            }
        }
    ...
    public static <T> List readJson2EntityList(String jsonString, Class<T> clazz) {
        if (jsonString != null) {
            ...
            try {
                ...
                logger.error("readJson2EntityList error jsonString={},class={}", jsonString, clazz.getName(), var4);
            }
        }
    ...
    public static <V> Map toMap(Object object) {
